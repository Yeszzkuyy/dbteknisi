# Login Page Redesign — `login.blade.php`

**File tujuan:** `resources/views/auth/login.blade.php`
**Branch:** `feature/login-redesign-v2`
...
|---|---|---|
| Proporsi grid | 45% : 55% | 40% : 60% |
| Border radius panel kanan | Kurva besar dramatis (`28%/50%`) | Melengkung tipis (`2.5rem`) |
| Lingkaran bola besar | Dihapus di commit `c1e15f4` | **Dikembalikan** sebagai `.login-sphere` |
| Daun dekoratif | Tidak ada | **Ditambahkan** SVG inline di 3 sudut |
| Judul form | `Sign in to your account` | `Sign In to your Account` |
| Label Email | `Email address` | `Email` |
| Placeholder Email | `you@company.com` | `Enter Email` |
| Placeholder Password | `Enter your password` | `Enter Password` |
| Teks tombol | `Sign In` | `SIGN IN` |
...
# Ganti isi file dengan kode di bawah, lalu:
npm run build
php artisan view:cache
php artisan test

git add resources/views/auth/login.blade.php
git commit -m "feat(auth): redesign login page sesuai referensi ilustrasi"
                    ...
                    <div class="login-visual" aria-hidden="true">
                        ...
                        <div x-ref="connectors" class="login-parallax">
                            ...
                            >
                                ...
                                <path class="connector-line" d="M52 50C50 45 48 38 46 30" />
                                ...
                                <circle cx="46" cy="30" r="1.3" fill="#BAE6FD" />
