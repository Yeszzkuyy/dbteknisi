...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-3xl font-bold text-slate-800 dark:text-slate-100">Tambah Sizing Project</h1>
            <p class="text-slate-500 dark:text-slate-400 mt-1">Catat kebutuhan customer dan usulan solusi teknis</p>
        </div>
