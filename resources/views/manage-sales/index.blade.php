        ...
        <div class="p-5 border-b dark:border-slate-600 bg-slate-50 dark:bg-slate-700 rounded-t-2xl">
            <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="sm:col-span-2 lg:col-span-2 flex items-end gap-2">
                    ...
                    <a href="{{ route('manage-sales.index') }}" class="px-4 py-2 rounded-xl bg-accent-500 hover:bg-accent-600 text-white font-medium transition">
                        Reset
                    </a>
                </div>
            </form>
                        ...
                        <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/40 transition align-middle">
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="{{ route('manage-sales.edit', $lead) }}" title="{{ __('Kelola lead (solusi, progress, catatan)') }}"
                                   class="inline-flex items-center justify-center p-2 rounded-xl bg-accent-100 hover:bg-accent-200 text-accent-700 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4">
