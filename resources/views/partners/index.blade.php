        ...
        <div class="p-5 border-b dark:border-slate-600 bg-slate-50 dark:bg-slate-700">
            <form method="GET" class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="sm:col-span-2 lg:col-span-2 flex items-end gap-2">
                    ...
                    <a href="{{ route('partners.index') }}" class="px-4 py-2 rounded-xl border border-slate-300 text-slate-700 hover:bg-white dark:border-slate-600 dark:text-slate-200 font-medium transition">
                        Reset
                    </a>
                </div>
            </form>
