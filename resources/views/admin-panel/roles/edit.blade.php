<x-app-layout>
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-slate-500 mt-1">{{ __('Perbarui nama role dan permission') }}</p>
        </div>
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex gap-2">
                        <button type="button" id="select-all" class="px-3 py-1 text-xs bg-blue-500 hover:bg-blue-600 text-white">{{ __('Pilih Semua') }}</button>
                        <button type="button" id="deselect-all" class="px-3 py-1 text-xs bg-blue-500 hover:bg-blue-600 text-white">{{ __('Batal Pilih') }}</button>
                    </div>
                </div>
