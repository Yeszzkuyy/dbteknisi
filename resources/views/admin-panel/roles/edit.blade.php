            ...
            <div class="mb-6">
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex gap-2">
                        <button type="button" id="select-all" class="px-3 py-1 text-xs bg-accent-500 hover:bg-accent-600 text-white">Pilih Semua</button>
                        <button type="button" id="deselect-all" class="px-3 py-1 text-xs bg-accent-500 hover:bg-accent-600 text-white">Batal Pilih</button>
                    </div>
                </div>
