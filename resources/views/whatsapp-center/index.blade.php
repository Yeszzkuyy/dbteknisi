...
<script>
    function whatsappCenter() {
        return {
            ...
            converting: false,
            convertError: '',
            settings: { enterToSend: true, mediaVisibility: true },
